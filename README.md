...
- 🗂️ **The complete official database — exactly 700 achievements / 7,000G** across CE Anniversary, Halo 2 + H2A MP, Halo 3, ODST, Reach, Halo 4, and MCC General *(Halopedia-sourced, cross-verified against live Xbox data; 14 wiki gamerscore errors corrected at import)*
- 🖼️ **Real achievement art, bundled** — all 700 official icons ship inside the APK (instant, fully offline); locked = greyscale, unlocked = full color
- 🧭 **Global search + sort** — search hits every game at once; sort any list by Top G, Quickest, or A–Z; filter chips show live counts
...
| **v1.2.3** | Exact **700 / 7,000G** reconciliation — full official set baked in, verified against live Xbox data (10 missing Halo 3 achievements added; 14 wiki gamerscore errors corrected) | ✅ shipped |
